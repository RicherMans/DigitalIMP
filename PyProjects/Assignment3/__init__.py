...
def parseargs():
    ...
    parser.add_argument('-k', '--kernel', choices=filters.keys(),
                        default='gaussian', help='The kernel, which is going to be used')
    parser.add_argument(
        '-sig', '--sigma', type=float, help='Sigma / Cutoff frequency')
